...
exports.Shell = exports.Head = undefined;
	...
	view: function view(_ref) {
		...
		return (0, _mithril2.default)(
			...
			(0, _mithril2.default)(
				...
				(0, _mithril2.default)(
					"a",
					{ "class": "dib toggle-button" },
					(0, _mithril2.default)("img", { src: "/assets/img/hamburger-menu.svg", "class": "w2" })
				)
			),
			(0, _mithril2.default)(
				"div",
				...
				(0, _mithril2.default)(
					"a",
					{ "class": "link white", oncreate: _mithril2.default.route.link, href: "/" },
					"DIDU"
				)
			),
			(0, _mithril2.default)(
